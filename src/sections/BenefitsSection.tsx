...
export default function BenefitsSection() {
  ...
  return (
    <section id="beneficios" className="py-24 sm:py-32 bg-white relative">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {benefits.map((benefit, idx) => (
            <div 
              key={idx}
              className="p-8 rounded-2xl bg-[#FAFAFA] border border-slate-100 flex flex-col md:flex-row gap-6 transition-all duration-300 hover:shadow-sm hover:border-slate-200"
            >
              <div className={`w-12 h-12 shrink-0 rounded-xl ${benefit.bgColor} ${benefit.iconColor} flex items-center justify-center`}>
                {benefit.svg}
              </div>
              <div>
