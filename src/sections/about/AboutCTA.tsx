  ...
  return (
    <section className="py-24 sm:py-32 bg-[#FAFAFA] relative border-t border-slate-100">
      <div className="max-w-5xl mx-auto px-6 sm:px-8 relative z-10">
        ...
        <div className="relative overflow-hidden rounded-[36px] bg-gradient-to-b from-white to-[#F8FAFC] border border-slate-200/60 p-12 sm:p-20 text-center flex flex-col items-center shadow-[0_24px_60px_-15px_rgba(15,23,42,0.02)]">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-primary tracking-tight mb-6 leading-[1.1] max-w-2xl">
            Construyamos consultorios más organizados y humanos.
          </h2>

          {/* Subtext */}
          <p className="text-lg sm:text-xl text-text font-normal leading-relaxed max-w-xl mb-12">
            Agenda una demostración y descubre cómo MADENT puede acompañar el crecimiento de tu práctica.
          </p>
